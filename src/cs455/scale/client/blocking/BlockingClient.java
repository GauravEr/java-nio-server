...
public class BlockingClient implements Runnable{
    ...
    public BlockingClient(String serverHost, int serverPort, int messageRate) throws IOException {
        ...
        tcpReceiver = new TCPReceiver(socket, new Callback() {
            ...
            public void invoke(byte[] receivedBytes) {
               ...
               // System.out.println("Received data:");
                ...
                String key = new String(receivedBytes, 0, 20);
...
//        }
//        System.out.println("---------------------------------------------");
        String key = new String(payload, 0, 20);
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 100; i++){
        try {
            BlockingClient client = new BlockingClient(hostName, port, msgRate);
            client.init();
